...
import { displayTime } from "./util/CustomFormat";
  ...
  const VideoPlayer =forwardRef(
    ...
    //video handlers
      ...
      return (
        <div className="relative rounded-2xl overflow-hidden aspect-[0.55] w-full max-w-[30rem] bg-black ">
  ...
  <div className="playerBtns items-end gap-3 px-3">
          ...
          <Progress className="flex-1 "
            ...
            videoDuration={videoDuration==Infinity ?props?.endTime:videoDuration}
